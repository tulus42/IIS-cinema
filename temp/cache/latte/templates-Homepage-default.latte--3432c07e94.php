<?php
// source: /opt/lampp/htdocs/IIS-cinema/app/templates/Homepage/default.latte

use Latte\Runtime as LR;

class Template3432c07e94 extends Latte\Runtime\Template
{
	public $blocks = [
...
<div id="content">
	...
	<section id="template">
		...
		<pre><code class="jush"><?php echo LR\Filters::escapeHtmlText(($this->filters->replacere)(file_get_contents($this->getName()), '#[\w+/]{60,}#', '…')) /* line 36 */ ?></code></pre>
	</section>
